...
#     """
#     """
#     packages = get_vars.get("ds389_packages")
...
@pytest.mark.parametrize("dirs", [
    ...
    "/etc/dirsrv/schema",
    "/etc/dirsrv/config",
    "/etc/dirsrv/slapd-default",
    "/var/lib/dirsrv",
    "/var/lib/dirsrv/slapd-default"
])
...
@pytest.mark.parametrize("files", [
    ...
    "/etc/dirsrv/slapd-default/dse.ldif",
    "/etc/dirsrv/slapd-default/schema/98-ssh.ldif"
])
...
def test_user(host):
    assert host.group("dirsrv").exists
    assert host.user("dirsrv").exists
    assert "dirsrv" in host.user("dirsrv").groups
    assert host.user("dirsrv").home == "/var/lib/dirsrv"


def test_service(host, get_vars):
    service = host.service("dirsrv@default")
